...
(function (HttpMessageBoard) {
     ...
     *
     */
    function getMessageListfromServer() {
        return __awaiter(this, void 0, void 0, function () {
            var messageListStr, messageList, htmlStr, _i, messageList_1, message, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, HttpMessageBoard.sendGetRequest("/message-list")];
                    case 1:
                        messageListStr = _a.sent();
